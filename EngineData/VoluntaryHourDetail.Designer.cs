...
public partial class VoluntaryHourDetailTable : DataTable {
// column indexes
...
public const int Application_FinalisedDateColumnIndex = 14;
public const int Application_LOIssueDateColumnIndex = 15;
public const int Application_FinalisedStatusColumnIndex = 16;
public const int Application_MobilePhoneNumberColumnIndex = 17;
public const int Application_MobilePhonePrefixColumnIndex = 18;
public const int Application_PhoneNumberColumnIndex = 19;
public const int Application_PhonePrefixColumnIndex = 20;
public const int Application_ContractTypeColumnIndex = 21;
public const int Application_MotherNameColumnIndex = 22;
public const int Application_FatherNameColumnIndex = 23;
public const int Application_SubmittedDateColumnIndex = 24;
public const int Application_UpdatedByColumnIndex = 25;
public const int Application_CreatedByColumnIndex = 26;
public const int Application_UpdatedDateColumnIndex = 27;
public const int Application_CreatedDateColumnIndex = 28;
public const int Application_StatusColumnIndex = 29;
public const int Application_DeletedColumnIndex = 30;
public const int Application_SubmittedColumnIndex = 31;
public const int Application_ConfirmAgreeTermsAndConditionColumnIndex = 32;
public const int Application_ConfirmReceiveMyPACNoticeColumnIndex = 33;
public const int Application_DeclarationAgreeColumnIndex = 34;
public const int Application_PQAcceptanceImageColumnIndex = 35;
public const int Application_PassportSizeImageColumnIndex = 36;
public const int Application_AcademicTranscriptImageColumnIndex = 37;
public const int Application_BirthCertificateImageColumnIndex = 38;
public const int Application_IdentificationImageColumnIndex = 39;
public const int Application_ScholarshipCostColumnIndex = 40;
public const int Application_ScholarshipProviderColumnIndex = 41;
public const int TSP_IDColumnIndex = 42;
public const int Application_NextExamSessionColumnIndex = 43;
public const int Application_RegisteredNextExamColumnIndex = 44;
public const int Application_PQDeadlineColumnIndex = 45;
public const int Application_PQLevelStartColumnIndex = 46;
public const int Application_PQStartDateColumnIndex = 47;
public const int Application_PGRegistrationNumberColumnIndex = 48;
public const int Application_PQQualificationColumnIndex = 49;
public const int Application_CGPAColumnIndex = 50;
public const int Application_UniversityColumnIndex = 51;
public const int Application_CurrentFieldOfStudyColumnIndex = 52;
public const int Application_CombinedHouseholdIncomeColumnIndex = 53;
public const int Application_MotherIdentificationColumnIndex = 54;
public const int Application_FatherIdentificationColumnIndex = 55;
public const int Application_EmailColumnIndex = 56;
public const int Country_IDColumnIndex = 57;
public const int Application_StateColumnIndex = 58;
public const int Application_CityColumnIndex = 59;
public const int Application_PostcodeColumnIndex = 60;
public const int Application_Address2ColumnIndex = 61;
public const int Application_Address1ColumnIndex = 62;
public const int Application_IdentificationNumberColumnIndex = 63;
public const int Application_NationalityColumnIndex = 64;
public const int Application_GenderColumnIndex = 65;
public const int Application_DOBColumnIndex = 66;
public const int Candidate_IDColumnIndex = 67;
...
public const int Application_OverallStatusColumnIndex = 71;
public const int Application_OverallProgressColumnIndex = 72;
public const int Application_CountryNameColumnIndex = 73;
public const int Application_IntakeMonthColumnIndex = 74;
public const int Application_IntakeYearColumnIndex = 75;
public const int Sponsor_IDColumnIndex = 76;
public const int Sponsor_CodeColumnIndex = 77;
public const int Sponsor_LabelColumnIndex = 78;
public VoluntaryHourDetailTable() {
TableName = "[VoluntaryHourDetail]";
// column VoluntaryHour_ID
DataColumn VoluntaryHour_IDCol = new DataColumn("VoluntaryHour_ID", typeof(System.Guid));
VoluntaryHour_IDCol.ReadOnly = true;
...
VoluntaryHour_TypeCol.ReadOnly = true;
...
VoluntaryHour_DurationCol.ReadOnly = true;
...
VoluntaryHour_StatusCol.ReadOnly = true;
...
VoluntaryHour_DescriptionCol.ReadOnly = true;
...
VoluntaryHour_CreatedByCol.ReadOnly = true;
...
VoluntaryHour_CreatedDateCol.ReadOnly = true;
...
VoluntaryHour_UpdatedByCol.ReadOnly = true;
...
VoluntaryHour_UpdatedDateCol.ReadOnly = true;
...
VoluntaryHour_IsDeletedCol.ReadOnly = true;
...
VoluntaryHour_RemarkCol.ReadOnly = true;
...
VoluntaryHour_DateCol.ReadOnly = true;
...
VoluntaryHour_TitleCol.ReadOnly = true;
...
return new VoluntaryHourDetailRow(builder);
}
public VoluntaryHourDetailRow GetVoluntaryHourDetailRow(int index) {
return (VoluntaryHourDetailRow)Rows[index];
}
}
public partial class VoluntaryHourDetailRow : DataRow {
internal VoluntaryHourDetailRow(DataRowBuilder builder) : base(builder) {
}
...
public VoluntaryHourDetailMinimalizedEntity() {}
public VoluntaryHourDetailMinimalizedEntity(VoluntaryHourDetailRow dr) {
...
public partial class VoluntaryHourDetailAdapter:AdapterBase {
SqlDataAdapter adapter;
public SqlDataAdapter Adapter {
get { return adapter; }
}
public VoluntaryHourDetailAdapter(DA da):base(da) {
InitializeAdapter();
}
...
public VoluntaryHourDetailRow GetByPrimaryKeys( ) {
string sql = "SELECT * FROM [VoluntaryHourDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);

VoluntaryHourDetailTable tbl = new VoluntaryHourDetailTable();
DA.ExecuteQuery(com, tbl);
if( tbl.Rows.Count == 0 ) return null;
else return tbl.GetVoluntaryHourDetailRow(0);
}
public int CountByPrimaryKeys( ) {
string sql = "SELECT COUNT(*) FROM [VoluntaryHourDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);
