...
public partial class ApplicationDetailTable : DataTable {
// column indexes
public const int Application_CampusNameColumnIndex = 0;
public const int Application_CampusCityColumnIndex = 1;
public const int Country_NameColumnIndex = 2;
public const int Application_IDColumnIndex = 3;
public const int Course_IDColumnIndex = 4;
public const int Application_DateColumnIndex = 5;
public const int Application_FullNameColumnIndex = 6;
public const int Candidate_IDColumnIndex = 7;
public const int Application_DOBColumnIndex = 8;
public const int Application_GenderColumnIndex = 9;
public const int Application_NationalityColumnIndex = 10;
public const int Application_IdentificationNumberColumnIndex = 11;
public const int Application_Address1ColumnIndex = 12;
public const int Application_Address2ColumnIndex = 13;
public const int Application_PostcodeColumnIndex = 14;
public const int Application_CityColumnIndex = 15;
public const int Application_StateColumnIndex = 16;
public const int Application_EmailColumnIndex = 17;
public const int Application_FatherIdentificationColumnIndex = 18;
public const int Application_MotherIdentificationColumnIndex = 19;
public const int Application_CombinedHouseholdIncomeColumnIndex = 20;
public const int Application_CurrentFieldOfStudyColumnIndex = 21;
public const int Application_UniversityColumnIndex = 22;
public const int Application_CGPAColumnIndex = 23;
public const int Application_PQQualificationColumnIndex = 24;
public const int Application_PGRegistrationNumberColumnIndex = 25;
public const int Application_PQStartDateColumnIndex = 26;
public const int Application_PQDeadlineColumnIndex = 27;
public const int Application_RegisteredNextExamColumnIndex = 28;
public const int Application_NextExamSessionColumnIndex = 29;
public const int TSP_IDColumnIndex = 30;
public const int Application_ScholarshipProviderColumnIndex = 31;
public const int Application_ScholarshipCostColumnIndex = 32;
public const int Application_IdentificationImageColumnIndex = 33;
public const int Application_BirthCertificateImageColumnIndex = 34;
public const int Application_AcademicTranscriptImageColumnIndex = 35;
public const int Application_PassportSizeImageColumnIndex = 36;
public const int Application_PQAcceptanceImageColumnIndex = 37;
public const int Application_DeclarationAgreeColumnIndex = 38;
public const int Application_ConfirmReceiveMyPACNoticeColumnIndex = 39;
public const int Application_ConfirmAgreeTermsAndConditionColumnIndex = 40;
public const int Application_SubmittedColumnIndex = 41;
public const int Application_DeletedColumnIndex = 42;
public const int Application_StatusColumnIndex = 43;
public const int Application_CreatedDateColumnIndex = 44;
public const int Application_UpdatedDateColumnIndex = 45;
public const int Application_CreatedByColumnIndex = 46;
public const int Application_UpdatedByColumnIndex = 47;
...
public const int Application_FinalisedStatusColumnIndex = 56;
public const int Application_LOIssueDateColumnIndex = 57;
public const int Application_FinalisedDateColumnIndex = 58;
public const int Application_OverallStatusColumnIndex = 59;
public const int Application_OverallProgressColumnIndex = 60;
public const int Application_IntakeMonthColumnIndex = 61;
public const int Application_IntakeYearColumnIndex = 62;
public const int Country_IDColumnIndex = 63;
public const int Application_PQLevelStartColumnIndex = 64;
public const int Application_IdentificationFileColumnIndex = 65;
public const int Application_BirthCertificateFileColumnIndex = 66;
public const int Application_AcademicTranscriptFileColumnIndex = 67;
public const int Application_PassportSizeFileColumnIndex = 68;
public const int Application_PQAcceptanceFileColumnIndex = 69;
public const int Application_CurrentlyEmployedColumnIndex = 70;
public const int Application_CompanyNameColumnIndex = 71;
public const int Application_CompanyContactColumnIndex = 72;
public const int Application_CompanyAddressColumnIndex = 73;
public const int Application_CompanyPositionColumnIndex = 74;
public const int Application_CompanySectorColumnIndex = 75;
public const int Application_CompanyDepartmentColumnIndex = 76;
public const int Application_IsAssessmentSessionAcceptedColumnIndex = 77;
public const int Sponsor_IDColumnIndex = 78;
public const int Sponsor_CodeColumnIndex = 79;
public const int Sponsor_LabelColumnIndex = 80;
public ApplicationDetailTable() {
TableName = "[ApplicationDetail]";
// column Application_CampusName
DataColumn Application_CampusNameCol = new DataColumn("Application_CampusName", typeof(System.String));
Application_CampusNameCol.ReadOnly = true;
Application_CampusNameCol.AllowDBNull = true;
Columns.Add(Application_CampusNameCol);
// column Application_CampusCity
DataColumn Application_CampusCityCol = new DataColumn("Application_CampusCity", typeof(System.String));
Application_CampusCityCol.ReadOnly = true;
Application_CampusCityCol.AllowDBNull = true;
Columns.Add(Application_CampusCityCol);
// column Country_Name
DataColumn Country_NameCol = new DataColumn("Country_Name", typeof(System.String));
Country_NameCol.ReadOnly = true;
Country_NameCol.AllowDBNull = true;
...
Application_IdentificationFileCol.ReadOnly = true;
...
Application_BirthCertificateFileCol.ReadOnly = true;
...
Application_AcademicTranscriptFileCol.ReadOnly = true;
...
Application_PassportSizeFileCol.ReadOnly = true;
...
Application_PQAcceptanceFileCol.ReadOnly = true;
...
Application_CurrentlyEmployedCol.ReadOnly = true;
...
Application_CompanyNameCol.ReadOnly = true;
...
Application_CompanyContactCol.ReadOnly = true;
...
Application_CompanyAddressCol.ReadOnly = true;
...
Application_CompanyPositionCol.ReadOnly = true;
...
Application_CompanySectorCol.ReadOnly = true;
...
Application_CompanyDepartmentCol.ReadOnly = true;
...
Application_IsAssessmentSessionAcceptedCol.ReadOnly = true;
...
Sponsor_CodeCol.AllowDBNull = true;
...
Sponsor_LabelCol.AllowDBNull = true;
Columns.Add(Sponsor_LabelCol);
}
protected override DataRow NewRowFromBuilder(DataRowBuilder builder) {
return new ApplicationDetailRow(builder);
}
public ApplicationDetailRow GetApplicationDetailRow(int index) {
return (ApplicationDetailRow)Rows[index];
}
}
public partial class ApplicationDetailRow : DataRow {
internal ApplicationDetailRow(DataRowBuilder builder) : base(builder) {
}
public System.String Application_CampusName {
get {
if( IsNull("Application_CampusName") ) return "";
else return (System.String)this["Application_CampusName"];
}
}
public System.String Application_CampusCity {
get {
if( IsNull("Application_CampusCity") ) return "";
else return (System.String)this["Application_CampusCity"];
}
}
public System.String Country_Name {
get {
if( IsNull("Country_Name") ) return "";
else return (System.String)this["Country_Name"];
}
}
...
get {
if( IsNull("Sponsor_Code") ) return "";
else return (System.String)this["Sponsor_Code"];
}
}
public System.String Sponsor_Label {
get {
if( IsNull("Sponsor_Label") ) return "";
else return (System.String)this["Sponsor_Label"];
}
}
}
public partial class ApplicationDetailMinimalizedEntity {
public ApplicationDetailMinimalizedEntity() {}
public ApplicationDetailMinimalizedEntity(ApplicationDetailRow dr) {
this.Application_CampusName = dr.Application_CampusName;
this.Application_CampusCity = dr.Application_CampusCity;
...
public partial class ApplicationDetailAdapter:AdapterBase {
SqlDataAdapter adapter;
public SqlDataAdapter Adapter {
get { return adapter; }
}
public ApplicationDetailAdapter(DA da):base(da) {
InitializeAdapter();
}
...
tmap.DataSetTable = "";
tmap.ColumnMappings.Add("Application_CampusName", "Application_CampusName");
tmap.ColumnMappings.Add("Application_CampusCity", "Application_CampusCity");
...
public ApplicationDetailRow GetByPrimaryKeys( ) {
string sql = "SELECT * FROM [ApplicationDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);

ApplicationDetailTable tbl = new ApplicationDetailTable();
DA.ExecuteQuery(com, tbl);
if( tbl.Rows.Count == 0 ) return null;
else return tbl.GetApplicationDetailRow(0);
}
public int CountByPrimaryKeys( ) {
string sql = "SELECT COUNT(*) FROM [ApplicationDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);
