...
public partial class StudentCourseDetailTable : DataTable {
// column indexes
...
public const int Application_IDColumnIndex = 10;
public const int Course_IDColumnIndex = 11;
public const int Application_DateColumnIndex = 12;
public const int Application_FullNameColumnIndex = 13;
public const int Candidate_IDColumnIndex = 14;
public const int Application_DOBColumnIndex = 15;
public const int Application_GenderColumnIndex = 16;
public const int Application_NationalityColumnIndex = 17;
public const int Application_IdentificationNumberColumnIndex = 18;
public const int Application_Address1ColumnIndex = 19;
public const int Application_Address2ColumnIndex = 20;
public const int Application_PostcodeColumnIndex = 21;
public const int Application_CityColumnIndex = 22;
public const int Application_StateColumnIndex = 23;
public const int Application_EmailColumnIndex = 24;
public const int Application_FatherIdentificationColumnIndex = 25;
public const int Application_MotherIdentificationColumnIndex = 26;
public const int Application_CombinedHouseholdIncomeColumnIndex = 27;
public const int Application_CurrentFieldOfStudyColumnIndex = 28;
public const int Application_UniversityColumnIndex = 29;
public const int Application_CGPAColumnIndex = 30;
public const int Application_PQQualificationColumnIndex = 31;
public const int Application_PGRegistrationNumberColumnIndex = 32;
public const int Application_PQStartDateColumnIndex = 33;
public const int Application_PQDeadlineColumnIndex = 34;
public const int Application_RegisteredNextExamColumnIndex = 35;
public const int Application_NextExamSessionColumnIndex = 36;
public const int TSP_IDColumnIndex = 37;
public const int Application_ScholarshipProviderColumnIndex = 38;
public const int Application_ScholarshipCostColumnIndex = 39;
public const int Application_IdentificationImageColumnIndex = 40;
public const int Application_BirthCertificateImageColumnIndex = 41;
public const int Application_AcademicTranscriptImageColumnIndex = 42;
public const int Application_PassportSizeImageColumnIndex = 43;
public const int Application_PQAcceptanceImageColumnIndex = 44;
public const int Application_DeclarationAgreeColumnIndex = 45;
public const int Application_ConfirmReceiveMyPACNoticeColumnIndex = 46;
public const int Application_ConfirmAgreeTermsAndConditionColumnIndex = 47;
public const int Application_SubmittedColumnIndex = 48;
public const int Application_DeletedColumnIndex = 49;
public const int Application_StatusColumnIndex = 50;
public const int Application_CreatedDateColumnIndex = 51;
public const int Application_UpdatedDateColumnIndex = 52;
public const int Application_CreatedByColumnIndex = 53;
public const int Application_UpdatedByColumnIndex = 54;
public const int Application_SubmittedDateColumnIndex = 55;
public const int Application_FatherNameColumnIndex = 56;
public const int Application_MotherNameColumnIndex = 57;
public const int Application_ContractTypeColumnIndex = 58;
public const int Application_PhonePrefixColumnIndex = 59;
public const int Application_PhoneNumberColumnIndex = 60;
public const int Application_MobilePhonePrefixColumnIndex = 61;
public const int Application_MobilePhoneNumberColumnIndex = 62;
public const int Application_FinalisedStatusColumnIndex = 63;
public const int Application_LOIssueDateColumnIndex = 64;
public const int Application_FinalisedDateColumnIndex = 65;
public const int Application_OverallStatusColumnIndex = 66;
public const int Application_OverallProgressColumnIndex = 67;
public const int Application_IntakeMonthColumnIndex = 68;
public const int Application_IntakeYearColumnIndex = 69;
public const int Country_IDColumnIndex = 70;
public const int Application_PQLevelStartColumnIndex = 71;
public const int TSP_CampusNameColumnIndex = 72;
public const int TSP_CityColumnIndex = 73;
public const int CourseSubject_CodeColumnIndex = 74;
public const int Absent_CountColumnIndex = 75;
public const int LatestExamScoreColumnIndex = 76;
public const int Coaching_UserAccount_IDColumnIndex = 77;
public const int Coaching_DescriptionColumnIndex = 78;
public const int Coaching_RemarkColumnIndex = 79;
public const int Sponsor_IDColumnIndex = 80;
public const int Sponsor_CodeColumnIndex = 81;
public const int Sponsor_LabelColumnIndex = 82;
public StudentCourseDetailTable() {
TableName = "[StudentCourseDetail]";
...
StudentCourse_CreatedDateCol.ReadOnly = true;
...
StudentCourse_UpdatedDateCol.ReadOnly = true;
...
StudentCourse_CreatedByCol.ReadOnly = true;
...
StudentCourse_UpdatedByCol.ReadOnly = true;
...
StudentCourse_DefermentReasonCol.ReadOnly = true;
...
TSP_CampusNameCol.AllowDBNull = true;
...
CourseSubject_CodeCol.AllowDBNull = true;
Columns.Add(CourseSubject_CodeCol);
// column Absent_Count
DataColumn Absent_CountCol = new DataColumn("Absent_Count", typeof(System.Int32));
Absent_CountCol.ReadOnly = true;
Absent_CountCol.AllowDBNull = true;
Columns.Add(Absent_CountCol);
// column LatestExamScore
DataColumn LatestExamScoreCol = new DataColumn("LatestExamScore", typeof(System.Decimal));
LatestExamScoreCol.ReadOnly = true;
LatestExamScoreCol.AllowDBNull = true;
Columns.Add(LatestExamScoreCol);
// column Coaching_UserAccount_ID
DataColumn Coaching_UserAccount_IDCol = new DataColumn("Coaching_UserAccount_ID", typeof(System.Guid));
Coaching_UserAccount_IDCol.ReadOnly = true;
Coaching_UserAccount_IDCol.AllowDBNull = true;
Columns.Add(Coaching_UserAccount_IDCol);
...
Coaching_DescriptionCol.AllowDBNull = true;
...
Coaching_RemarkCol.AllowDBNull = true;
...
return new StudentCourseDetailRow(builder);
}
public StudentCourseDetailRow GetStudentCourseDetailRow(int index) {
return (StudentCourseDetailRow)Rows[index];
}
}
public partial class StudentCourseDetailRow : DataRow {
internal StudentCourseDetailRow(DataRowBuilder builder) : base(builder) {
}
...
get {
if( IsNull("TSP_CampusName") ) return "";
else return (System.String)this["TSP_CampusName"];
}
}
public System.String TSP_City {
get {
if( IsNull("TSP_City") ) return "";
else return (System.String)this["TSP_City"];
}
}
public System.String CourseSubject_Code {
get {
if( IsNull("CourseSubject_Code") ) return "";
else return (System.String)this["CourseSubject_Code"];
}
}
public System.Int32? Absent_Count {
get {
if( IsNull("Absent_Count") ) return null;
else return (System.Int32)this["Absent_Count"];
}
}
public System.Decimal? LatestExamScore {
get {
if( IsNull("LatestExamScore") ) return null;
else return (System.Decimal)this["LatestExamScore"];
}
}
public System.Guid? Coaching_UserAccount_ID {
get {
if( IsNull("Coaching_UserAccount_ID") ) return null;
else return (System.Guid)this["Coaching_UserAccount_ID"];
}
}
public System.String Coaching_Description {
get {
if( IsNull("Coaching_Description") ) return "";
else return (System.String)this["Coaching_Description"];
}
}
public System.String Coaching_Remark {
get {
if( IsNull("Coaching_Remark") ) return "";
else return (System.String)this["Coaching_Remark"];
}
}
...
public StudentCourseDetailMinimalizedEntity() {}
public StudentCourseDetailMinimalizedEntity(StudentCourseDetailRow dr) {
...
this.Absent_Count = dr.Absent_Count;
this.LatestExamScore = dr.LatestExamScore;
this.Coaching_UserAccount_ID = dr.Coaching_UserAccount_ID;
...
public partial class StudentCourseDetailAdapter:AdapterBase {
SqlDataAdapter adapter;
public SqlDataAdapter Adapter {
get { return adapter; }
}
public StudentCourseDetailAdapter(DA da):base(da) {
InitializeAdapter();
}
...
tmap.ColumnMappings.Add("Absent_Count", "Absent_Count");
tmap.ColumnMappings.Add("LatestExamScore", "LatestExamScore");
tmap.ColumnMappings.Add("Coaching_UserAccount_ID", "Coaching_UserAccount_ID");
...
public StudentCourseDetailRow GetByPrimaryKeys( ) {
string sql = "SELECT * FROM [StudentCourseDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);

StudentCourseDetailTable tbl = new StudentCourseDetailTable();
DA.ExecuteQuery(com, tbl);
if( tbl.Rows.Count == 0 ) return null;
else return tbl.GetStudentCourseDetailRow(0);
}
public int CountByPrimaryKeys( ) {
string sql = "SELECT COUNT(*) FROM [StudentCourseDetail] WHERE ";
SqlCommand com = new SqlCommand(sql);
