<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Alumni.ascx.cs" Inherits="Alumni" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Alumni Work History List</span></td>   
                <td align="right">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
              ...
              <%--      <td class="largetext" valign="top">Search Voluntary Hour Approval List</td>--%>
                    <td>
                        <table class="Form">
                            <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search Alumni Work History List</td>
                            </tr>
                            <tr>
                                <td>Full Name :</td>
