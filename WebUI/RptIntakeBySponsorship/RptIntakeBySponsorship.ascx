<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RptIntakeBySponsorship.ascx.cs" Inherits="RptIntakeBySponsorship" %>
...
<div id="<%= ClientID%>_divMain" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Intake By Sponsorship Report</span></td>   
                <td align="right">
