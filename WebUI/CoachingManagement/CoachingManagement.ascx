<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CoachingManagement.ascx.cs" Inherits="CoachingManagement" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Counselling / Mentoring List</span></td>   
                <td align="right">
    ...
    <div id="<%=ClientID%>_divSearch">
        <div class="HeaderDropPanel">
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                  <%--  <td class="largetext" valign="top">Search Counselling / Mentoring List</td>--%>
                    <td>
                        <table class="Form">
                            <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search Counselling / Mentoring List</td>
                            </tr>
                            <tr>
                                <td>Full Name :</td>
                            ...
                            <tr>
                                <td>Assessment Date From :</td>
                                <td><input type="text" id="<%=ClientID%>_txtSearchAssessmentDateFrom" class="searchdate" /> ~ <input type="text" id="<%=ClientID%>_txtSearchAssessmentDateTo" class="searchdate" /></td>
                            </tr>
                            <tr>
                                <td>Contract Type :</td>
