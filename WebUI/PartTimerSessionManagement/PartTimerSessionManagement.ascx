<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PartTimerSessionManagement.ascx.cs" Inherits="PartTimerSessionManagement" %>

<div id="<%= ClientID%>_divMain" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Part-Timer Assessment Session Management</span></td>   
                <td align="right">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                    ...
                    <td>
                        <table class="Form">
                            <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search Part-Timer Assessment Session</td>
                            </tr>
                            <tr>
                                <td>Session Date :</td>
