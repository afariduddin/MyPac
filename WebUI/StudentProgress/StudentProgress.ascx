<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StudentProgress.ascx.cs" Inherits="StudentProgress" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Student Progress List</span></td>   
                <td align="right">
                    <button id="<%=ClientID%>_btnShowSearch">Search</button>
                    <button id="<%=ClientID%>_btnImport">Import</button>
                    <button id="<%=ClientID%>_btnDownloadImport"  onclick="window.open('ExcelSample/StudentWeeklyProgress.xlsx')">Download Import Format</button>
                    <%--<button id="<%=ClientID%>_btnExport">Download Excel</button>--%>
                </td>             
            </tr>
        </table>
    </div>
    ...
    <div id="<%=ClientID%>_divSearch">
        <div class="HeaderDropPanel">
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                 <%--   <td class="largetext" valign="top">Search Student Progress List</td>--%>
                    <td>
                        <table class="Form">
                            <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search Student Progress List</td>
                            </tr>
                            <tr>
                                <td>Registration Date :</td>
                                <td><input type="text" id="<%=ClientID%>_dpSearchDateFrom" class="searchdate" /> ~
                            ...
                            <tr>
                                <td>Status :</td>
                                <td><select id="<%=ClientID%>_selSearchStudentCourseStatusType" class="search">
                                    </select></td>
                            </tr>
                        </table>
                    </td>
