local.RptActiveStudentSummaryPageController = function (idPrefix) {
    var self = this;
    ...
    function Initialize() {
        ...
        $(btnExport).attr('disabled', false).unbind().click(function () {
            ...
            RptActiveStudentSummaryAjaxGateway.GetResult(yearfrom, yearto, tsp, sponsor, true, function (res) {
                if (res.error == null) {
                    window.open("ExportReport.aspx?ReportName=RptActiveStudentSummary");
                }
            });
        });
    }
    ...
    function Activated() {
        ...
        navigationTrail = {
            Name: "Report - Active Student Summary",
            Link: "#"
        };
        navigationTrails.push(navigationTrail);
    ...
    function BuildSurfaceListing() {
        ...
        self.ListControlller.SearchDelegate = function () {
            ...
            RptActiveStudentSummaryAjaxGateway.GetResult(yearfrom, yearto, tsp, sponsor, false, function (res) {
                if (res.error == null) {
        ...
        self.ListControlller.PopulateDataDelegate = function (tbl) {
            ...
            //Generate Chart
            RptActiveStudentSummaryAjaxGateway.GetColumnChart(function (res) {
                if (res.error == null) {
                    imgURL = res.value;
                    $(divChart).empty();
    ...
    var Title = "Active Student Summary Report";
    self.Title = Title;
