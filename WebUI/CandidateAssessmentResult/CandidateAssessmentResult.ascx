<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CandidateAssessmentResult.ascx.cs" Inherits="CandidateAssessmentResult" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Assessment Result List</span></td>   
                <td align="right">
                    <button id="<%=ClientID%>_btnShowSearch">Search</button>
                  <%--  <button id="<%=ClientID%>_btnAssign">Import Assessment Result</button>
    ...
    <div id="<%=ClientID%>_divSearch">
        <div class="HeaderDropPanel">
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                    <td class="largetext" valign="top">Search Assessment Result List</td>
                    <td>
                        <table class="Form">
                            ...
                            <tr>
                                <td>Status :</td>
                                <td><select id="<%=ClientID%>_selSearchStatus">
                                    <option>- Select All - </option>
                                    <option>Confirmed</option>
                                    <option>Declined</option>
                                    <option>CLO Sent</option>
