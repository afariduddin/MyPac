<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserGroupManagement.ascx.cs" Inherits="UserGroupManagement" %>

<div id="<%= ClientID%>_divMain" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%=ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">User Group Management</span></td>   
                <td align="right">
    ...
    <div id="<%=ClientID%>_divSearch">
        <div class="HeaderDropPanel">
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                    <%--<td class="largetext" valign="top">Search System User Group</td>--%>
                    <td>
                        <table class="Form">
                            <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search System User Group</td>
                            </tr>
                            <tr>
                                <td>Group Name :</td>
