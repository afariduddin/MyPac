<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CandidateCourseMonitoring.ascx.cs" Inherits="CandidateCourseMonitoring" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="WIDTH:100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
            <tr valign="middle">
                <td ><span id="<%= ClientID%>_spanTitle" style="font-weight:bold; font-size:1.1em;">Course Monitoring</span></td>   
<%--                <td align="right">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="HEIGHT:100%;">
                <tr>
                    ...
                    <td>
                        <table class="Form">
                      <tr>
                                 <td colspan="2" class="searchtitle" valign="top">Search Course List</td>
                            </tr>
                     
                            <tr>
                                <td>Course :</td>
                                <td><input type="text" id="<%=ClientID%>_txtSearchCourse" class="search" /></td>
                            </tr>
                        </table>
                    </td>
                    <td valign="bottom">
