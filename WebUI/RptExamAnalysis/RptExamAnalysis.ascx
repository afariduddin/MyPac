<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RptExamAnalysis.ascx.cs" Inherits="RptExamAnalysis" %>

<div id="<%= ClientID%>_divReportContent" class="divContent" style="width: 100%;">
    <div class="PageHeader">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr valign="middle">
                <td><span id="<%= ClientID%>_spanTitle" style="font-weight: bold; font-size: 1.1em;">Student Exam Analysis Report</span></td>
                <td align="right">
                    ...
                    <td>
                        <table class="Form">
                            ...
                            <tr>
                                <td>TSP : </td>
                                <td>
                                    <div id="<%=ClientID%>_chkSearchTSP" class="search"  />
                                </td>
                            </tr>
                            <tr>
                                <td>Course : </td>
                                <td>
                                    <select id="<%=ClientID%>_selSearchCourse" class="search" ></select>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <div id="<%=ClientID%>_divList">
        <div class="Wrap" style="width: 100%;">
            <div class="WrapPadding">
                ...
                <table id="<%=ClientID%>_tblPager" class="Pager" style="display: none"></table>
            </div>
        </div>
    </div>
